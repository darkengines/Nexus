...
public enum WebSocketMessageType {
    ...
    CHANNEL_CREATED(0x35), CREATE_CHANNEL(0x36), ACCEPT_CHANNEL_INVITATION(0x37), CHANNEL_CHAT_MESSAGE(0x38), CALL(0x39), CHANNEL_CALL(0x40), CHANNEL_OFFER(0x41), CHANNEL_ANSWER(0x42);
